...
contract Oracle is Governable {
        ...
        returns (int256 answer)
    {
        ...
        (, answer, , , ) = AggregatorV3Interface(
            chainLinkAggregatorMap[underlying]
        ).latestRoundData();
    ...
    function setAggregator(address underlying, address aggregator)
        external
        onlyGovernance
    {
        ...
        require(
            ...
            "Expected oracle to have 8 decimals"
        );
    ...
    function setStablePrice(address underlying, int256 price)
        external
        onlyGovernance
    {
        requireNonEmptyAddress(underlying);
